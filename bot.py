...
def call_claude(prompt: str) -> str:
    ...
    try:
        ...
        print("[ERROR] call_claude: タイムアウト（180秒）")
        return "(Claude がタイムアウトしました。時間をおいて再試行してください。)"
...
def call_gemini(prompt: str) -> str:
    ...
    try:
        ...
        print("[ERROR] call_gemini: タイムアウト（180秒）")
        return "(Gemini がタイムアウトしました。時間をおいて再試行してください。)"
